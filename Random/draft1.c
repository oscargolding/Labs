...
int basicConversion (int city, int timeUTC) {
    ...
    if (city == 0) {
        ...
        a = ACWST(timeUTC);
        return a;
    } else if (city >= 2 && city <= 4) {
        a = ACST(timeUTC);
        return a;
    } else if (city >= 5 && city <= 9) {
        a = AEST(timeUTC);
        return a;
    } else if (city == 10) {
        a = LHST(timeUTC);
...
int getRealTime (int city, int day, int month, int localTime, int timeUTC) {
    if (city == 0 || city == 1 || city == 3 || city == 9) {
        return localTime;
    }
    // Branch for Australian Cities.
    else if (city == 2 || city == 4 || city == 5 || city == 6 || city == 7 || city == 8) {
        if (month > 4 && month < 9) {
            return localTime;
    ...
    // NZ Branch
    else if (city == 11 || city == 12 || city == 13) {
        if (month > 4 && month < 9) {
            return localTime;
