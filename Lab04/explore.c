...
int main(int argc, const char * argv[]) {
    ...
    // The max sizes of larger integer values.
    long long qw = 9223372036854775807;
    printf("The min of long long is %lld, adding one fails.\n", qw);

    long long qe = -9223372036854775807;
    printf("The min of long long is %lld, minusing one fails.\n", qe);

    long as = 9223372036854775807;
    printf("The max of long is %ld, adding one fails\n", as);

    long ea = -9223372036854775807;
    printf("The max of long is %ld, minusing one fails\n", ea);

    float dc = 2147483650;
    printf("The max of float is %f, adding one fails\n", dc);

    float dvb = -2147483650;
    printf("The min of float is %f, minusing one fails\n", dvb);
    ...
    printf("The size of the dobule float is 1.7E+308.");

    printf("The smallest size of double float is -1.7E+308.");
